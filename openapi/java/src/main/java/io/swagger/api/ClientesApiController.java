...
public class ClientesApiController implements ClientesApi {
    ...
    public ResponseEntity<Object> apiFacturasGet(@Pattern(regexp="^\\d+$") @Parameter(in = ParameterIn.PATH, description = "**ID**.   ID del cliente.  type: number format: uuid", required=true, schema=@Schema()) @PathVariable("idCliente") Integer idCliente) {
